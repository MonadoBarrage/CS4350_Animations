...
#include <vector>
#include <memory>
#include "GLViewCS4350_Final_Animations.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewCS4350_Final_Animations > glView( Aftr::GLViewCS4350_Final_Animations::New( args ) );
